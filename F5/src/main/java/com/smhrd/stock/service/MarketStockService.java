...
public class MarketStockService {
    ...
    public String getMarketStockPrice(String marketCode) {
        ...
        headers.set("authorization", "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJ0b2tlbiIsImF1ZCI6IjkzNmIxMGVlLWRiNmEtNDg2ZS1iNmUzLWViYWQ3YTg5NTUxMCIsInByZHRfY2QiOiIiLCJpc3MiOiJ1bm9ndyIsImV4cCI6MTc1MDIxNjY5NywiaWF0IjoxNzUwMTMwMjk3LCJqdGkiOiJQU2tPQXB6SG1iQ054Wk1qMzdjWkduU1RFaFJzMVVxSUNSSk0ifQ.h_m-pOPpLQtTYEbqXM3n7cWyKrARaGaXjYqcfj4Da_29SWxZSjLyL78M1HdRtHUQa6gD0nBtDieSp4C5H-p0ag"); // 발급받은 최신 토큰
        ...
        headers.set("tr_cont", "");
        headers.set("mac_address", "24-4B-FE-CC-D7-DA");
