...
import SupplyDemandAnalysisContent from './pages/AiInfoPage/components/SupplyDemandAnalysisContent.jsx';
          ...
          <main className="app-main-content-centered"> {/* <<--- 중앙 메인 콘텐츠 영역 */}
            <Routes>
              ...
              <Route path="/ai-info" element={<AiInfoPageLayout />}>
                ...
                <Route path="supply-demand-analysis" element={<SupplyDemandAnalysisContent />} />
